...
public class DirectoryTree extends JTree {
    ...
    public DirectoryTree() {
        super(new DirectoryTreeNode("Roots", fileSystemView.getRoots(), fileSystemView));
        ...
        // Versichere, dass die Kinder des DirectoryTreeNode vor dem Expandieren
        // geladen sind.
    ...
    private FileSystemView getFileSystemView() {
        return DirectoryTree.fileSystemView;
    }
}
