...
import acdsee.gui.util.BaseMouseListener;
...
public class SelectionContainer extends JPanel {
    ...
    public SelectionContainer(JComponent c) {
    ...
    public Collection getSelectedComponents() {
        ...
        for (Component component : comp) {
            ((AbstractThumbnail)component).setSelected(false);
            Rectangle r = component.getBounds();
            if (selection != null && SwingUtilities.isRectangleContainingRectangle(selection, r)) {
                selectedComponents.add(component);
                ((AbstractThumbnail)component).setSelected(true);
            }
        }
