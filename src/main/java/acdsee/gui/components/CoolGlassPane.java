 ...
 */
public class CoolGlassPane extends JPanel implements DragSourceMotionListener, DragSourceListener {
    ...
    public void dragMouseMoved(DragSourceDragEvent dsde) {
        if (img == null) {
            AbstractThumbnail proxy = (AbstractThumbnail) dsde.getDragSourceContext().getTransferable();
